...
-- AddForeignKey
ALTER TABLE "CourseProgress" ADD CONSTRAINT "CourseProgress_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "UserCourse"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
